...
description: "Archetypals desktop is the easiest way to use Archetypals for most people."
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypals Installation"
/>

## Installation Overview

Archetypals Desktop is a "**single-player**" application you can install on any Mac, Windows, or Linux operating system and get local LLMs, RAG, and Agents with little to zero configuration and full privacy.

## Docker vs Desktop Version

Archetypals offers two main ways to use Archetypals. There are some distinct differences in functionality between each offering. Both are open source.

### You want Archetypals Desktop if...
...
### You want Archetypals Docker if...

- You need an easy setup, but server-based service for Archetypals to use local LLMs, RAG, and Agents locally
- You want to run an Archetypals instance that many people can use at the same time
...
- You want to access Archetypals from the browser
...
<Callout type="info" emoji="️💡">
  **Tip:** Archetypals Desktop is the easiest way to use Archetypals.
</Callout>
...
<Cards>
  <Card title="System Requirements" href="system-requirements"> 
    <Image
      ...
      width={1920} 
      quality={100}
      alt="Archetypals System Requirements"
    />
  </Card>
...
<Card title="Windows Install" href="windows">
  <Image
    ...
    width={1920}
    quality={100}
    alt="Archetypals Windows Install"
  />
</Card>
...
<Card title="Local Docker Install" href="/installation-docker/local-docker">
  <Image
    ...
    width={1920}
    quality={100}
    alt="Archetypals Local Docker Install"
  />
</Card>
...
>
  ...
  <Card title="Cloud Docker Install" href="/installation-docker/cloud-docker"> 
    <Image
      ...
      width={1920} 
      quality={100}
      alt="Archetypals Cloud Docker Install"
    />
  </Card>  
</Cards>
