...
description: "This guide explain how to setup AI Agents on Archetypals"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypals Agent Configuration Menu"
/>
...
<Callout type="info" emoji="️ℹ️">
  **Note**
    ...
    Archetypals supports a lot of LLM providers for use with `@agent`s and you can see all the supported LLMs from [here](https://docs.anythingllm.com/features/language-models#supported-language-model-providers)
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypals Agent Web Browsing"
/>

With Google Search Engine you can perform up to 100 search for free everyday.

**That's it! You can now use Archetypals's Agents!**
