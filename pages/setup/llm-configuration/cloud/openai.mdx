---
title: "OpenAI LLM"
description: "OpenAI is the most popular closed-source option for many Archetypal users"
---
...
All OpenAI models are currently available for use with Archetypal.
