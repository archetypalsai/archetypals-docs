---
title: "Archetypal Default Embedder"
description: "Archetypal ships with a built-in embedder model that runs on CPU"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypal Default Embedder"
/>

# Archetypal Default Embedder
...
Archetypal ships with a built-in embedder model that runs on CPU.
