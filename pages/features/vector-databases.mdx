...
description: "Archetypal allows you to use a host of LLM providers for chatting and generative AI."
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypal Vector Databases"
/>

# Vector Databases

Archetypal comes with a private built-in vector database powered by [LanceDB](https://lancedb.com/). Your vectors never leave Archetypal when using the default option.

Archetypal supports many vector databases providers out of the box.
