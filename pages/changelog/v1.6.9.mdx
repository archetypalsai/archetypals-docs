---
title: "v1.6.9"
description: "Archetypals Desktop v.1.6.9 Changelog"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypals Changelog v1.6.9"
/>
...
You can now import any Ollama model tag or Hugging Face model into Archetypals using the default Ollama provider. Simply enter the tag or URL and hit import.
...
<Image
  ...
  width={1920}
  quality={100}
  alt="Archetypals Import Model"
/>

### Computer Use (Anthropic AI)

Archetypals can now leverage the new [Anthropic AI Computer Use]() models.
