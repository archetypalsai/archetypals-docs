...
description: "How to debug agent flows in Archetypals"
---
...
You can view the logs of an executed flow by [opening the logs of Archetypals](/installation-desktop/debug).
